...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "ea096841-dfb7-4cb8-ac98-442249c468e5",
...
const _lazy_GzC8ek = () => import('../routes/api/study-rooms/_id_.mjs');
const _lazy_Itl0OD = () => import('../routes/api/index.mjs');
const _lazy_9WOP_D = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/study-rooms/:id', handler: _lazy_GzC8ek, lazy: true, middleware: false, method: undefined },
  { route: '/api/study-rooms', handler: _lazy_Itl0OD, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_9WOP_D, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_9WOP_D, lazy: true, middleware: false, method: undefined }
];
