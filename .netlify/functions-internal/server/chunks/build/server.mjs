...
import { o as hasProtocol, p as isScriptProtocol, q as joinURL, w as withQuery, s as sanitizeStatusCode, t as getContext, $ as $fetch, v as createHooks, x as executeAsync, l as createError$1, y as toRouteMatcher, z as createRouter$1, A as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "gps",
    path: "/gps",
    component: () => import('./gps-sYRjkCAP.mjs')
  },
  {
    name: "crud",
    path: "/crud",
    component: () => import('./crud-C7ywut8W.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DxkHVNo2.mjs')
  },
  {
    name: "reserve",
    path: "/reserve",
    component: () => import('./reserve-Dm60uVBy.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DVMSdU-2.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-kbk1YMZX.mjs'));
