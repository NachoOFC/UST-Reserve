          ...
          <div class="flex items-center justify-between h-20">
            ...
            <div class="flex items-center space-x-3">
              ...
              <div class="relative">
                ...
                <!-- Dropdown del perfil -->
                  <div v-if="showUserMenu" class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                    <div class="px-4 py-3 border-b border-gray-100">
                      <p class="text-sm font-semibold text-gray-900 truncate">{{ userName }}</p>
                      <p class="text-xs text-gray-500 truncate" v-if="userEmail">{{ userEmail }}</p>
                    </div>
                    
                    <!-- Opciones solo si no es invitado -->
                    <div v-if="user && !user.anon">
                      <button 
                        @click="goToProfile"
                        class="w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center space-x-2"
                      >
                    ...
                    <div v-if="user && user.anon" class="px-4 py-2 border-b border-gray-100 text-xs text-gray-600 text-center">
